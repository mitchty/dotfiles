...
* ~/.profile
#+BEGIN_SRC sh :tangle tmp/.profile :results replace
# -*- mode: Shell-script; -*-
# Common .profile
...
First param is the message, second title of the notification.
 ...
 sh :tangle tmp/bin/notify :results replace :tangle-mode (identity #o755)
#+BEGIN_SRC sh :tangle (when (eq osx-p t) "tmp/bin/notify") :results replace :tangle-mode (identity #o755)
#!/bin/sh
